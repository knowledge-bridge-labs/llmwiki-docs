...
development scripts. Use the published `llmwiki-serve==0.2.6` package when you
...
`uvx --from llmwiki-serve==0.2.6 llmwiki-serve ...` for the source server. Use
...
`npm exec --package llmwiki-agent-bridge@0.3.0 -- llmwiki-agent-bridge` when
